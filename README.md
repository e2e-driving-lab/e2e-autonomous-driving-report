...
In comparison, a game tree is a tool for enumerating the order of actions (state transitions), not a representation of causal structure. Game‑tree optimization necessarily proceeds through trial‑and‑error exploration, a process that is safe only within virtual domains such as Go and Shogi. 
