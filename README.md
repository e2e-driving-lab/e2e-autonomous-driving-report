...
Rather than proposing a specific AI algorithm, the paper analyzes the architectural conditions necessary for reconstructible decision rationale and institutional responsibility attribution.
...
In comparison, a game tree is a tool for enumerating state transitions such as the order of actions, not a representation of causal structure. Game‑tree optimization necessarily proceeds through trial‑and‑error exploration, a process that is safe only within virtual domains such as Go and Shogi. 
