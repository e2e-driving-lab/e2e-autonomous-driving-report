...
and further discussed an evaluation method for E2E autonomous driving models using the propensity score.

Scope of this paper
This paper focuses on the structural requirements for decision explainability in autonomous driving.

Rather than proposing a specific AI algorithm, the paper analyzes the architectural conditions necessary for reconstructable decision rationale and institutional responsibility attribution.
